...
if arg in ['all', 'cartpole']:
    ...
    names = [
        "Valence-Prioritized Experience Replay (VPER) -- ReLU Priorities, Actor Only",
        "Valence-Prioritized Experience Replay (VPER) -- ReLU Priorities, Actor and Critic",
        "Valence-Prioritized Experience Replay (VPER) -- Exp Priorities, Actor Only",
        "Valence-Prioritized Experience Replay (VPER) -- Exp Priorities, Actor and Critic",
    ]
